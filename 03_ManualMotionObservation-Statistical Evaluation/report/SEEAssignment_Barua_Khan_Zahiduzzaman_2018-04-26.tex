			...
			\subsection{Design of Robot}
				\begin{itemize}
					...
					\begin{figure}[H]
						...
						\label{fig:Robotfig}
					\end{figure}
					\item \textcolor{blue}{In addition, as shown above in the bottom view, it is ensured that the caster wheel does not rotate more than 360$^\circ$}.
				\end{itemize}
			\input{ground-truth}
			\subsection{\textcolor{blue}{Transformations}}							
				\begin{itemize}
					...
					\item The \textit{row} variable has three components, x-coordinate, y-coordinate and the angle of orientation of the robot. 
				\end{itemize}
